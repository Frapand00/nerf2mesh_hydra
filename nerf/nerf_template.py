...
class Trainer(object):
    ...
    def eval_step(self, data):
        ...
        outputs = self.model.render(rays_o, rays_d, index=index, bg_color=bg_color, perturb=False,
    ...
    def fit(self, train_loader, valid_loader, max_epochs):
    ...
    def train_one_epoch(self, loader):
        ...
        for data in loader:
            ...
            if self.scheduler_update_every_step:
                self.lr_scheduler.step()
                self.model.lr_scheduler_step(scheduler_cfg["scheduler"], monitor)
