...
# import pycolmap
from nerf.colmap_utils import (
    qvec2rotmat,
    read_cameras_binary,
    read_images_binary,
    read_points3d_binary,
)
from process_data.process_data_utils import CameraModel
from utils_studio import colormaps
from utils_studio.rich_utils import status
from utils_studio.scripts import run_command
...
def run_colmap(
    ...
    # Bundle adjustment
    sparse_dir = colmap_dir / "colmap_sparse"
